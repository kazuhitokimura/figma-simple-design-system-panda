...
export const AppTable = () => {
  ...
  const mockData: { value: string; isLink?: boolean }[][] = [
    [
      { value: "Cell 1-1", isLink: false },
      { value: "Cell 1-2", isLink: true },
      { value: "Cell 1-3", isLink: false },
      { value: "Cell 1-4", isLink: false },
      { value: "Cell 1-5", isLink: true },
    ],
    [
      { value: "Cell 2-1", isLink: false },
      { value: "Cell 2-2", isLink: false },
      { value: "Cell 2-3", isLink: true },
      { value: "Cell 2-4", isLink: false },
      { value: "Cell 2-5", isLink: false },
    ],
    [
      { value: "Cell 3-1", isLink: true },
      { value: "Cell 3-2", isLink: false },
      { value: "Cell 3-3", isLink: false },
      { value: "Cell 3-4", isLink: true },
      { value: "Cell 3-5", isLink: false },
    ],
    [
      { value: "Cell 4-1", isLink: false },
      { value: "Cell 4-2", isLink: false },
      { value: "Cell 4-3", isLink: false },
      { value: "Cell 4-4", isLink: true },
      { value: "Cell 4-5", isLink: false },
    ],
    [
      { value: "Cell 5-1", isLink: true },
      { value: "Cell 5-2", isLink: false },
      { value: "Cell 5-3", isLink: false },
      { value: "Cell 5-4", isLink: false },
